...
<div class="container-fluid py-3">
    ...
    <div class="row">
        <div class="col-md-6">
            <p class="mb-3">
                ...
                <?php echo htmlspecialchars($pk['nama_produk']); ?>
            </p>
            <p class="mb-3">
                <strong>Jumlah Direncanakan:</strong><br>
                <?php echo number_format($pk['jumlah_direncanakan']); ?> unit
            </p>
            <?php if ($pk['status'] == 'Selesai'): ?>
                <p class="mb-3">
                    <strong>Hasil Produksi:</strong><br>
                    <span class="text-success fw-bold"><?php echo htmlspecialchars($pk['jumlah_sukses']); ?> Sukses</span>, 
                    <span class="text-danger fw-bold"><?php echo htmlspecialchars($pk['jumlah_gagal']); ?> Gagal</span>
                </p>
            <?php endif; ?>
        </div>
        <div class="col-md-6">
            <p class="mb-3">
                ...
                <?php echo date('d M Y, H:i', strtotime($pk['tanggal_dibuat'])); ?>
            </p>
            <p class="mb-3">
        ...
        <div class="col-12">
             <p class="mb-0">
                 ...
                 <?php echo nl2br(htmlspecialchars($pk['catatan'])); ?>
             </p>
        </div>
        <?php endif; ?>
    </div>
    ...
    <?php elseif ($pk['status'] == 'Berlangsung'): ?>
        <form action="index.php?page=produksi_aksi_selesai" method="POST" onsubmit="return validasiHasil()">
            ...
            <div class="row align-items-end justify-content-end">
                <div class="col-md-3 mb-2">
                    <label for="jumlah_sukses" class="form-label d-block text-start">Jml Sukses</label>
                    <input type="number" class="form-control" name="jumlah_sukses" id="jumlah_sukses" min="0" required>
                </div>
                <div class="col-md-3 mb-2">
                    <label for="jumlah_gagal" class="form-label d-block text-start">Jml Gagal</label>
                    <input type="number" class="form-control" name="jumlah_gagal" id="jumlah_gagal" min="0" required>
                </div>
                <div class="col-md-3 mb-2">
                    <label class="form-label d-block text-start invisible">Aksi</label> <button type="submit" class="btn btn-info w-100">Selesaikan Produksi</button>
                </div>
            </div>
        </form>
        <script>
        function validasiHasil() {
            ...
            if ((jumlahSukses + jumlahGagal) !== jumlahDirencanakan) {
                alert('Error: Total jumlah Sukses dan Gagal (' + (jumlahSukses + jumlahGagal) + ') tidak sama dengan Jumlah yang Direncanakan (' + jumlahDirencanakan + ').');
                return false;
            }
            return true;
        }
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="m-0">Bahan Baku yang Direncanakan untuk Digunakan</h6>
        </div>
        <div class="card-body">
