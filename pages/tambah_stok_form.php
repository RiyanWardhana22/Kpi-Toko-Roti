...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt_insert->execute([
            $kode_batch, $id_bahan_baku,
            $jumlah_input, $satuan_input, // Simpan data display apa adanya
            $jumlah_dikonversi, $jumlah_dikonversi, // Simpan data terkonversi
            $harga_per_satuan_dasar,
            $tanggal_masuk, $tanggal_kadaluarsa, $id_pengguna_input
        ]);
...
<div class="container-fluid py-3">
    <div class="card">
        <div class="card-header"><h6 class="m-0">Form Tambah Stok Bahan Baku</h6></div>
        <div class="card-body">
            <?php if (isset($error)): ?>
