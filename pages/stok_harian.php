...
<div class="container-fluid py-3">
    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="index.php?page=tambah_stok_form" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Tambah Stok Baru</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr><td colspan="8" class="text-center p-5 bg-light">Belum ada data stok yang tersedia. Silakan tambah stok baru.</td></tr>
                        <?php else: ?>
