    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            if (isset($_SESSION['pesan_sukses'])) {
                echo '<div class="alert alert-success mb-3">' . htmlspecialchars($_SESSION['pesan_sukses']) . '</div>';
                unset($_SESSION['pesan_sukses']);
            }
            if (isset($_SESSION['pesan_error'])) {
                echo '<div class="alert alert-danger mb-3">' . htmlspecialchars($_SESSION['pesan_error']) . '</div>';
                            ...
                            <?php foreach ($bahan_bakus as $bahan): ?>
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center gap-2">
                                        ...
                                        <a href="<?php echo base_url('index.php?page=bahan_baku_hapus&id=' . $bahan['id_bahan_baku']); ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Anda yakin? Bahan baku yang sudah digunakan dalam resep tidak bisa dihapus.');" title="Hapus Master"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
