            ...
            try {
                        ...
                        if (isset($_FILES['favicon']) && $_FILES['favicon']['error'] === UPLOAD_ERR_OK) {
                                    ...
                                    if (in_array($file['type'], $allowed_types)) {
                                                ...
                                                if ($current_favicon && file_exists($target_dir . $current_favicon) && $current_favicon != $filename) {
            ...
            <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                            <label for="nama_website" class="form-label">Nama Website (di Sidebar)</label>
                                                ...
                                                <div class="mb-3">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                        <img src="<?php echo base_url('assets/images/' . htmlspecialchars($settings['favicon'])); ?>" alt="Favicon" class="me-3" style="width: 32px; height: 32px;">
                                                                        <input type="file" class="form-control" id="favicon" name="favicon">
                                                            </div>
                                                            <small class="text-muted">Kosongkan jika tidak ingin mengubah favicon. Tipe file yang diizinkan: .ico, .png, .jpg, .gif.</small>
                                                </div>
                                                <hr>
