...
--
-- Host: localhost:3306
-- Generation Time: Aug 14, 2025 at 10:21 AM
...
(1, 'SEL-20250814085806', 10, '1000', 'Gram', '1000.00', '760.00', '25.00', '2025-08-14', '2025-08-21', 6),
(2, 'STR-20250814085825', 12, '15', 'Buah', '15.00', '10.00', '2333.33', '2025-08-14', '2025-08-17', 6),
(3, 'TEL-20250814085900', 11, '20', 'Butir', '20.00', '0.00', '2150.00', '2025-08-14', '2025-08-21', 6),
(4, 'TEP-20250814085935', 9, '15000', 'Gram', '15000.00', '14983.00', '3.00', '2025-08-14', '2025-08-21', 6),
(5, 'TEL-20250814100008', 11, '12', 'Butir', '12.00', '10.00', '2000.00', '2025-08-14', '2025-08-21', 6);
...
--
ALTER TABLE `perintah_kerja`
  MODIFY `id_perintah_kerja` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `perintah_kerja_penggunaan_batch`
--
ALTER TABLE `perintah_kerja_penggunaan_batch`
  MODIFY `id_penggunaan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `produk_jadi_batch`
  MODIFY `id_batch_produk` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `stok_batch`
  MODIFY `id_batch` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
