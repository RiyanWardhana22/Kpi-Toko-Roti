...
// TAMBAHKAN GRUP BARU UNTUK STOK
$stok_pages = ['stok_harian', 'tambah_stok_form'];
$produksi_pages = ['produksi', 'produksi_daftar', 'produksi_buat', 'produksi_detail'];
...
// TAMBAHKAN VARIABEL BARU UNTUK STOK
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <div class="collapse submenu <?php echo $is_stok_active ? 'show' : ''; ?>" id="stokSubmenu">
                    <ul class="nav flex-column">
                        <li><a class="dropdown-item <?php echo $current_page == 'stok_harian' ? 'active' : ''; ?>" href="<?php echo base_url('index.php?page=stok_harian'); ?>">Daftar Stok & Batch</a></li>
                        <li><a class="dropdown-item <?php echo $current_page == 'tambah_stok_form' ? 'active' : ''; ?>" href="<?php echo base_url('index.php?page=tambah_stok_form'); ?>">Tambah Stok Baru</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
